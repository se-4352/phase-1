...
The goal of this project is to develop a smart home application system that will be used in multiple homes in order to ensure a secure and comfortable living style for the guests.
This project will highlight the safety needs of any homeowner and make living more convenient than traditional homes through surveillance and tracking as well as automating most of parts of the homes.
This project will assist the property owner in remotely managing the different homes and all the permissions each property manager and guest has in order to establish a successful rental property business.
